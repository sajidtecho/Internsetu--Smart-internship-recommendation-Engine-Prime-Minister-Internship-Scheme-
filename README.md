InternSetu -An internship recommendation engine PM Internship Portal
Smart Internship Recommendation System for the Government of India
...
Low Bandwidth Optimised: Works on 2G/3G networks
📊 Performance
First Contentful Paint: < 1.5s
Time to Interactive: < 3.0s
Lighthouse Score: 95+
Bundle Size: Optimised with code splitting
🤝 Contributing
